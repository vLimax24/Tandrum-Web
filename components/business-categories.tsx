      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="pb-12 md:pb-20">
          ...
          <div className="relative flex h-[324px] items-center justify-center">
            ...
            <div className="absolute inset-x-[200px] top-1/2 -z-10 h-px bg-linear-to-r from-transparent via-[#10B981]/60 to-transparent mix-blend-multiply"></div>
            <div className="absolute inset-x-0 top-1/2 -z-10 h-px -translate-y-[82px] bg-linear-to-r from-transparent via-gray-200 to-transparent mix-blend-multiply before:absolute before:inset-y-0 before:w-24 before:animate-[line_10s_ease-in-out_infinite_both] before:bg-linear-to-r before:via-[#10B981]"></div>
            <div className="absolute inset-x-0 top-1/2 -z-10 h-px translate-y-[82px] bg-linear-to-r from-transparent via-gray-200 to-transparent mix-blend-multiply before:absolute before:inset-y-0 before:w-24 before:animate-[line_10s_ease-in-out_infinite_5s_both] before:bg-linear-to-r before:via-[#10B981]"></div>
            {/* Diagonal lines */}
              ...
              <article className="flex h-full w-full items-center justify-center">
                {[
                  ...
                  },
                  {
                    ...
                    x: "-translate-x-[216px] -translate-y-[82px]",
                    delay: "1s",
                    size: "h-20 w-20",
                    w: 50,
                    h: 46,
                  ...
                  <div
                    key={idx}
                    className={`absolute ${img.x} ${img.opacity || ""}`}
                  >
                    <div
                      className={`animate-[breath_6s_ease-in-out_${img.delay}_infinite_both]`}
                    >
                      <div
                        className={`flex ${img.size} items-center justify-center rounded-full bg-white shadow-lg shadow-black/[0.03] border border-gray-200/60 before:absolute before:inset-0 before:m-[8.334%] before:rounded-[inherit] before:border before:border-gray-700/5 before:bg-gray-200/60 before:[mask-image:linear-gradient(to_bottom,black,transparent)]`}
                      >
                        <Image
                          src={img.src}
                          width={img.w}
